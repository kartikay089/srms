...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="index.php">SRMS-(Student Result Management thing)</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item"><a class= "nav-link active" href="https://t.me/srmssyetm2" target="_blank"> <span>  Go To SRMS Telegram</span></a></li>
                    </ul>
                </div>
            </div>
        </nav>
